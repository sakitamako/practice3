...
public class RegistCompleteDAO {
	...
	// + "family_name, last_name, family_name_kana, last_name_kana, mail,
	// password, "
	...
	// public void regist(String userFamilyName, String userLastName, String
	// userFamilyNameKana,
	// String userLastNameKana, String userMail, String userPassword, String
	// userGender,
	// String userPostalCode, String userPrefecture, String userAddress1, String
	// userAddress2, String userAuthority) throws SQLException {
	// regist(userFamilyName, userLastName, userFamilyNameKana,
	// userLastNameKana, userMail, userPassword, userGender, userPostalCode,
	// userPrefecture, userAddress1, userAddress2, userAuthority);
	// }
