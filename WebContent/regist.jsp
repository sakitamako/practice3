			...
			<table>
				<s:form action="RegistConfirmAction" method="post" >
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="userGender" value="0" <s:if test="%{userGender == '男性' || userGender == null}">checked="checked"</s:if>>男性
                            <input type="radio" name="userGender" value="1" <s:if test="%{userGender == '女性'}">checked="checked"</s:if>>女性
                        </td>
                    </tr>
                    <tr>
